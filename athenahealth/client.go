...
type Client interface {
	...
	ListPatientsMatchingCustomField(ctx context.Context, customFieldID, customFieldValue string, opts *ListPatientsMatchingCustomFieldOptions) (*ListPatientsMatchingCustomFieldResult, error)
}
